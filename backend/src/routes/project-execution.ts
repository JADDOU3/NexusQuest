    ...
    switch (language.toLowerCase()) {
        ...
        case 'cpp': {
            ...
            if (hasCMake) {
                ...
                // We check if conan_toolchain.cmake exists (generated by conan install)
                return `cd ${baseDir} && mkdir -p build && cd build && if [ -f conan_toolchain.cmake ]; then cmake .. -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=conan_toolchain.cmake; else cmake .. -DCMAKE_BUILD_TYPE=Release; fi && cmake --build . && ./main`;
            } else {
    ...
    try {
        ...
        if (dependencies && Object.keys(dependencies).length > 0) {
            if (language === 'javascript') {
                ...
                // Generate conanfile.txt from dependencies object
                ...
                // Run conan profile detect (idempotent-ish, or just force)
