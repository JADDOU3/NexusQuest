...
interface TaskExecutionRequest extends Request {
    body: {
        code: string;
 ...
 * Execute task code with streaming output
 */
router.post('/execute', async (req: TaskExecutionRequest, res: Response) => {
 ...
 * Send input to running task container
 */
...
export { router as taskExecutionRouter };
