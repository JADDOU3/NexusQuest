...
export function Projects({ user, onLogout }: ProjectsProps) {
    ...
    const handleCreateProject = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Navigate to the new project - the main file will be automatically created and displayed
            ...
            <main className="max-w-6xl mx-auto px-4 py-8">
                ...
                {projects.length === 0 ? (
                    <div className="text-center py-16">
                        ...
                        <p className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} mb-6`}>Create your first project to get started with a main file</p>
                        <Button
                            onClick={() => setShowNewProject(true)}
